...
RECOVERY_MOD_VERSION := $(RECOVERY_MOD_NAME) $(RECOVERY_TYPE) $(shell echo $(PHILZ_BUILD) | cut -d . -f 1)
RECOVERY_MOD_VERSION_BUILD := $(RECOVERY_MOD_NAME) $(RECOVERY_TYPE) $(PHILZ_BUILD)
